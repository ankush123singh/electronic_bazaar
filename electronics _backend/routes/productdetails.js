...
router.post('/submit_product_details', upload.single('picture'), function (req, res) {
    try {
        pool.query('insert into productdetails (productid, brandid, categoryid, modelno, description, color, price, offerprice, stock, status, hsncode, picture) values (?,?,?,?,?,?,?,?,?,?,?,?)',
            [req.body.productid, req.body.brandid, req.body.categoryid, req.body.modelno, req.body.description, req.body.color, req.body.price, req.body.offerprice, req.body.stock, req.body.status, req.body.hsncode, req.file.filename], function (error, result) {
                if (error) {
